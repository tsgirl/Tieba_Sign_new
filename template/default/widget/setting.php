...
<p>签到方式：</p>
<p><label><input type="radio" name="sign_method" id="sign_method_1" value="1" />模拟电脑网页签到</label></p>
<p><label><input type="radio" name="sign_method" id="sign_method_2" value="2" />模拟手机网页签到</label></p>
<p><label><input type="radio" name="sign_method" id="sign_method_3" value="3" />模拟手机客户端签到（默认）</label></p>
<p>如果经常出现漏签，可以尝试更换签到方式</p>
<p><label><input type="checkbox" disabled name="force_sign" id="force_sign" value="1" />使用一键签到接口暴力签到被封禁贴吧，适用于强迫症患者</label></p>
<p>附加签到：</p>
...
<p>stoken是百度近来投入使用的另一个认证cookie，随bduss一起保存在浏览器中，7.4.5之后版本的客户端也需要此参数</p>
<p>**测试性功能**</p>
<p>自动点赞贴子获得经验：(需要有效的stoken)</p>
<p><label><input type="text" name="autoagree" id="autoagree" list="autocomplete-tieba" placeholder="输入贴吧名,不带最后`吧`字,留空关闭此功能" /></label></p>
